...
?>
<div class="col-10">
 <a href="index.php?halaman=tambah_alternatif">
 ...
 <table class="table table-bordered">
  <thead>   
   <tr style="font-weight: bold">
    <td width="5%">No.</td>
    <td width="30%">Kode</td>
    <td width="35%">Nama Alternatif</td>
  ...
  <tbody>
   ...
   <tr>
    ...
    <td>
     <a href="index.php?halaman=edit_alternatif&id_alternatif=<?php echo $row['id_alternatif'] ?>">
